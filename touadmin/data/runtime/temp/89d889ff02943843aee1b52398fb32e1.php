<?php /*a:1:{s:70:"C:\cyq\touadmin\public/themes/admin_simpleboot3/admin\index\index.html";i:1557192482;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <link href="/touadmin/public/static/font-awesome/css/font-awesome.min.css?page=index" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="/touadmin/public/themes/admin_simpleboot3/public/assets/themes/<?php echo cmf_get_admin_style(); ?>/simplebootadminindex.min.css">
    <!--[if lt IE 9]>
                ...
                <li class="light-blue dropdown" style="border-left:none;">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <?php if(isset($admin['avatar']) && $admin['avatar']): ?>
                            ...
                            <?php else: ?>
                            <img class="nav-user-photo" width="30" height="30"
                                 src="/touadmin/public/themes/admin_simpleboot3/public/assets/images/logo-18.png" alt="<?php echo (isset($admin['user_login']) && ($admin['user_login'] !== '')?$admin['user_login']:''); ?>">
                        <?php endif; ?>
...
<div class="main-container container-fluid">
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-shortcuts" id="sidebar-shortcuts">
            <a class="btn btn-sm btn-warning" href="/touadmin/public/"
...
<script src="/touadmin/public/themes/admin_simpleboot3/public/assets/simpleboot3/js/adminindex.js"></script>
<script>
    $(function () {
