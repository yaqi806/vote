<?php /*a:2:{s:58:"C:\cyq\touadmin\public/themes/simplemall/vote\\shenhe.html";i:1569221263;s:59:"C:\cyq\touadmin\public/themes/simplemall/public\header.html";i:1557192482;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap">
    ...
    <form class="well form-inline margin-top-20" method="post" action="<?php echo url('vote/adminIndex/index2'); ?>">
        用户ID：
        ...
        <a class="btn btn-danger" href="<?php echo url('vote/adminIndex/index2'); ?>">清空</a>
    </form>
                ...
                <tr>
                    ...
                    <td>
                                <a class="btn btn-xs btn-warning js-ajax-dialog-btn"
                                   href="<?php echo url('vote/adminIndex/qiyong',array('id'=>$vo['p_id'])); ?>"
